<div class="pt-4 pb-2">
    <h5 class="card-title text-left pb-0 fs-1">London Wassup Meyt</h5>
</div>
...
<div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
            <div class="hero-image">
              <img src="assets/img/KOGMO.avif" alt="Construction Project" class="img-fluid">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row align-items-center g-5">
          <div class="col-lg-6">
            <div class="about-content" data-aos="fade-right" data-aos-delay="200">
              <h2>Made by Gacita with the help of bootstrap template</h2>
          ...
          <div class="col-lg-6">
            <div class="about-image position-relative" data-aos="fade-left" data-aos-delay="200">
              <img src="assets/img/construction/JehvShibal.jpg" alt="Construction Team" class="img-fluid main-image rounded">
              <div class="image-overlay">
                <img src="assets/img/18+.jpg" alt="Construction Project" class="img-fluid rounded">
              </div>
